...
confirms copy-forward as a causally necessary mechanism for the adaptive peak,
not merely a correlated feature.
...
\begin{itemize}
  ...
  \item \textbf{Mechanism attribution} (Experiment~6): Ablating the copy-forward
    ...
    causally sufficient for the amplification.
...
not the exact $\nu$ and $\kappa$ thresholds. Testing under different wave
amplitudes, frequencies, or spatial patterns remains for future work; the
...
shift. Each regime boundary corresponds to violation of one of the four
...
causally validates the key mechanism; and scaling to $N = 800$ rules out
